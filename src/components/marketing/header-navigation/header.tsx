...
const headerNavItems: HeaderNavItem[] = [
    { label: "Products", href: "/services", menu: <DropdownMenuSimpleWithFooter /> },
    { label: "Services", href: "/services", menu: <DropdownMenuFeatureCard /> },
    { label: "Pricing", href: "/pricing" },
    { label: "Resources", href: "/about", menu: <DropdownMenuWithTwoColsAndLinksAndFooter /> },
                    ...
                    <div className="flex flex-1 items-center gap-5">
                        <a href="/" className="flex items-center gap-1.5">
                            <div className="size-10 shrink-0 overflow-hidden rounded-[22%]">
                                <img src={logoMini.src} alt="Mirimera" className="size-full object-cover" />
                            </div>
                            <img src={logo.src} alt="Mirimera" className="h-6 w-auto object-contain md:max-lg:hidden" />
                        </a>
