                ...
                <Dialog>
                    <div className="relative w-full overflow-hidden rounded-2xl bg-primary shadow-xl sm:max-w-100">
                        ...
                        <div className="relative flex flex-col gap-3 px-4 sm:px-6">
                            <Toggle id="twitter" size="sm" label="Share on X" hint="@yourcompany" defaultSelected />
                            <Toggle id="medium" size="sm" label="Share on Medium" hint="yourcompany.medium.com" defaultSelected />
                            <Toggle id="facebook" size="sm" label="Share on Facebook" hint="@yourcompany" />
                        </div>
