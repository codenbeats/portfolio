...
export const DestructiveHorizontalModal = () => {
                    ...
                    <div className="relative w-full overflow-hidden rounded-2xl bg-primary shadow-xl sm:max-w-136">
                        ...
                        <div className="flex flex-col gap-4 px-4 pt-5 sm:flex-row sm:px-6 sm:pt-6">
                            <div className="relative size-max">
                                <FeaturedIcon color="error" size="md" theme="modern" icon={Trash01} />
                            </div>
                            <div className="relative flex flex-col gap-0.5">
                                <AriaHeading slot="title" className="text-md font-semibold text-primary">
                                    Delete blog post
                                </AriaHeading>
                                <p className="text-sm text-tertiary">Are you sure you want to delete this post?</p>
                            </div>
                        </div>
