                ...
                <Dialog>
                    <div className="relative w-full overflow-hidden rounded-2xl bg-primary shadow-xl sm:max-w-100">
                        ...
                        <div className="flex flex-col gap-3 px-4 sm:px-6">
                            <Checkbox id="twitter" size="sm" label="Share on X" />
                            <Checkbox id="medium" size="sm" label="Share on Medium" />
                            <Checkbox id="facebook" size="sm" label="Share on Facebook" />
                        </div>
