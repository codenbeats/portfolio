...
const socials = [
    ...
    {
        label: "LinkedIn",
        href: "https://www.linkedin.com/in/kittisorasu/",
        icon: (
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                                ...
                                {socials.map((social) => (
                                    <li key={social.label}>
                                        <a
                                            ...
                                            className="flex size-11 items-center justify-center rounded-full border border-secondary text-fg-tertiary transition-all duration-200 hover:-translate-y-0.5 hover:border-brand hover:text-fg-brand-primary"
                                        >
                                            {social.icon}
                                        </a>
                                    </li>
